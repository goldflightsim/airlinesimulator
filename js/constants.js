...
const CABIN_QUALITIES = {
  low:      { label: 'Economy fit-out',  fareMult: 0.82, maintMult: 0.75, priceMult: 0.85 },
  standard: { label: 'Standard fit-out', fareMult: 1.00, maintMult: 1.00, priceMult: 1.00 },
  high:     { label: 'Premium fit-out',  fareMult: 1.25, maintMult: 1.40, priceMult: 1.25 }
};
